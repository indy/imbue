...
var ejs = require('../vendor/ejs/index');
...
exports.renderBody = function(bindings, body) {
  var ejsRender = renderBodyEJS(bindings, body);
  var r, mdConvertor;

  if(bindings.page._noMarkdown || bindings._useMarkdown == false) {
    r = ejsRender;
  } else {
    mdConvertor = new showdown.Showdown.converter();
