...
exports.renderStringEJS = function(bindings, str) {
  return renderContentsEJS(bindings, str);
}
...
exports.renderFileEJS = function(bindings, fname) {
  var str = fs.readFileSync(fname, 'utf8');
  return renderContentsEJS(bindings, str);
}

// todo: test this
exports.getHB = function(str) {
  return headerAndBody(str);
}

// todo: test this
exports.getHBFromFile = function(fname) {
  var str = fs.readFileSync(fname, 'utf8');
  return headerAndBody(str);
}
