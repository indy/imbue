...
exports.render = function(bindings, body, useMarkdown) {
  return render(bindings, body, useMarkdown);
}


function render(bindings, body, useMarkdown) {

  if(typeof bindings === 'string') {
    // if bindings is a simple string then bind it to 'content'
